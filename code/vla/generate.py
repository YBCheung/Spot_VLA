...
Run with: python scripts/generate.py --model_path openvla/openvla-7b-prismatic # <PATH TO LOCAL MODEL OR HF HUB>
"""
...
img_path = "/home/spot/openvla/code/hold_stick.jpg"
...
def generate(cfg: GenerateConfig) -> None:
    ...
    vlm.to(device, dtype=torch.bfloat16)     # TODO: may change to int4
    ...
    # Build Prompt
    prompt_builder.add_turn(role="human", message="what is the arm holding")
